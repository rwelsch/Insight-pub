...
<?php
    ...
    $req = $db->query("
        ...
        FROM Step1_Ex3_Characteristics
            LEFT OUTER JOIN (SELECT * FROM Step1_Ex3_Users WHERE user_id=".$_SESSION['userID'].") T
              ON Step1_Ex3_Characteristics.id = T.char_id
...
<h3  style="text-align: center;">
    <a href="index.php?lang=<?php echo $lang;?>&target=step1ex3&init=true">< <?php echo($translate['redo']); ?> <</a>
    <a href="index.php?lang=<?php echo $lang;?>&target=step1ex4" style="margin-left:5em;">> <?php echo($translate['next']); ?> ></a>
</h3>