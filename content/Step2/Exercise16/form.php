...
<form name="step2ex16_form" action="index.php?target=step2ex16&lang=<?php echo($lang)?>" method="POST">
    ...
    <table width="100%" style="border-collapse:collapse">
        <?php
            $row = 0;
            $req = $db->query("SELECT id, $lang as value, rank FROM Step2_Ex16_Things ORDER BY rank");
    ...
    <table width="100%" style="border-collapse:collapse">
        <tr>
            <td width="25%" style="valign:top;" class="single" id="value_1"><?php echo($data['choice']) ?> 1<input id ="form_value_1" type="hidden"  name="value_1"  value="0" /></td>
            <td width="25%" style="valign:top;" class="single" id="value_2"><?php echo($data['choice']) ?> 2<input id ="form_value_2" type="hidden"  name="value_2"  value="0" /></td>
            <td width="25%" style="valign:top;" class="single" id="value_3"><?php echo($data['choice']) ?> 3<input id ="form_value_3" type="hidden"  name="value_3"  value="0" /></td>
            <td width="25%" style="valign:top;" class="single" id="value_4"><?php echo($data['choice']) ?> 4<input id ="form_value_4" type="hidden"  name="value_4"  value="0" /></td>
        </tr>
    </table>
    </div>
