...
<form name="step4ex21_form" action="index.php?target=step4ex21&lang=<?php echo($lang)?>" method="POST">
 
    <table width="100%" style="border-collapse:collapse">
    <?php
        $row = 0;
        $req = $db->query("SELECT id, rank, $lang FROM Step4_Ex21_Characteristics ORDER BY rank");
