...
<?php
    ...
    $req = $db->query("
        ...
        FROM Step4_Ex20_Points
            LEFT OUTER JOIN (SELECT * FROM Step4_Ex20_Users WHERE user_id=".$_SESSION['userID'].") T
              ON Step4_Ex20_Points.id = T.point_id
...
<h3  style="text-align: center;">
    <a href="index.php?lang=<?php echo $lang;?>&target=step4ex20&init=true">< <?php echo($translate['redo']); ?> <</a>
    <a href="index.php?lang=<?php echo $lang;?>&target=step4ex21" style="margin-left:5em;">> <?php echo($translate['next']); ?> ></a>
</h3>